  ...
  (define elf-program-header% ;; typedef struct elf64_phdr {} Elf64_Phdr;
    (class object%
      ...
      (init-field
       ...
       offset ;; Elf64_Off p_offset;		/* Segment file offset */
       address ;; Elf64_Addr p_vaddr;		/* Segment virtual address */
       ;; Elf64_Addr p_paddr;		/* Segment physical address */
       size ;; Elf64_Xword p_filesz;		/* Segment size in file */
      ...
      (define/public (get-bytes)
        ...
        (unsigned 64 address) ;; Elf64_Addr p_vaddr;		/* Segment virtual address */
        (unsigned 64 address) ;; Elf64_Addr p_paddr;		/* Segment physical address */
